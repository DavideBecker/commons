...
export const isMobile = ((dc, wd) => {
  ...
  try {
    ...
    'ontouchstart' in wd ||
    'ontouchstart' in dc.documentElement ||
    (wd.DocumentTouch && wd.document instanceof DocumentTouch) ||
    wd.navigator.maxTouchPoints ||
    wd.navigator.msMaxTouchPoints
      ? void 0
      : new Error('failed check "ontouchstart" event')
